...
public class Cone extends SceneObject {
    ...
    public Vector normalAt(Point worldPoint) {
        ...
        if (dist < 1 && objectPoint.getY() >= maximum - 0.00001) {
            ...
            objectNormal = new Vector(objectPoint.getX(), y, objectPoint.getZ());
        }
    ...
    private boolean checkCap(Ray ray, double t, double y) {
